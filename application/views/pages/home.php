...
<div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
  ...
  <h4 id="list-item-3">Antennes collectives</h4>
  <p><ul>
  	<li>TNT</li>
  	<li>SAT</li>
  	<li>FM</li>
  ...
  <h4 id="list-item-4">Hall imeuble</h4>
  <p><ul>
  	<li>Porte de hall</li>
  	<li>Boîtes aux lettres</li>
  	<li>...</li>
  </ul></p>
  <h4 id="list-item-5">Automatisme et petites serrureries</h4>
  <p><ul>
  ...
  <h4 id="list-item-6">Sécurité/Sinistre</h4>
  <p><ul>
